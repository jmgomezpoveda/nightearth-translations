...
$lang['INDEX_BODY']        = '<p>Карта ночь Земля показывает огни, которые видны ночью на поверхности Земли.</p>
    ...
    <p>День / ночь наложения использует <a href="https://github.com/marmat/google-maps-api-addons">Google Maps API Addons</a>.</p>
...
// Google Earth
$lang['GOOGLEEARTH_H1']    = 'Google Планета Земля: Карта мира в 3D';
$lang['GOOGLEEARTH_BODY1'] = 'Теперь вы можете видеть изображение <cite>Ночь Земли</cite> внутри <cite>Google Планета Земля</cite>.';
$lang['GOOGLEEARTH_BODY2'] = 'Для того чтобы просмотреть <cite>Ночь Земли</cite> изображения, помещенные внутри <cite>Google Earth</cite>:';
$lang['GOOGLEEARTH_BODY3'] = 'Нажмите сюда, чтобы добавить ночь изображений в Google Планета Земля';
$lang['GOOGLEEARTH_BODY4'] = 'Если вы не имеете <cite>Google Earth</cite> установлен, вы можете загрузить его <b>бесплатно</b>.';
