...
$lang['INDEX_BODY']        = '<p>Карта ночь Земля показывает огни, которые видны ночью на поверхности Земли.</p>
    ...
    <p>3D Карта была создана с использованием <a href="http://cesiumjs.org/" target="_blank">Cesium</a> через <a href="http://openlayers.org/" target="_blank">OpenLayers</a> и <a href="https://github.com/openlayers/ol3-cesium/" target="_blank">ol3-cesium</a>. Это использует образы из <a href="http://www.openstreetmap.org/" target="_blank">OpenStreetMap</a>, <a href="http://www.thunderforest.com/" target="_blank">Thunderforest</a>, <a href="https://www.mapbox.com/" target="_blank">Mapbox</a>, и <a href="https://www.mapquest.com/" target="_blank">Mapquest</a>.</p>
