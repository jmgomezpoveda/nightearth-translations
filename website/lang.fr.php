...
$lang['INDEX_BODY']        = '<p>La carte nuit de la Terre montre les lumières qui sont visibles la nuit à la surface de la Terre.</p>
	...
	<ul><li>L\'image principale de la Terre dans la nuit (2012) a été capturé par <a href="http://earthobservatory.nasa.gov/?eocn=topnav&amp;eoci=logo">NASA</a> utilisant le Suomi National Polar-orbiting Partnership (Suomi NPP) satellite. Il a fallu pendant neuf jours en Avril 2012 et treize jours en Octobre 2012, au cours de 312 orbites à 824 km (512 miles) pour capturer la Terre entière. Ce satellite utilise la "bande jour-nuit" de la Visible Infrared Imaging Radiometer Suite (VIIRS), qui détecte la lumière dans une gamme de longueurs d\'onde du vert au proche infrarouge et utilise des techniques de filtrage pour observer des signaux sombres tels que les éruptions de gaz, les aurores boréales, les incendies, les lumières de la ville, et reflète le clair de lune.</li>
	<li>L\'<a href="showitem.php?item=night_map_earth">image d\'origine à partir de 2000</a> a été créé par <a href="http://www.nasa.gov" target="_blank">NASA</a> en utilisant les données de l\'<a href="http://www.ngdc.noaa.gov/dmsp/" target="_blank">Defense Meteorological Satellite Program (DMSP)</a>\'s <a href="http://thunder.msfc.nasa.gov/ols/" target="_blank">Operational Linescan System (OLS)</a>, conçu à l\'origine pour afficher des nuages ​​au clair de lune.</li></ul>
	<p>Les images de jour fournies par Google Maps (cartes et vues satellites) sont également disponibles à titre de référence. le <a href="https://developers.google.com/maps/">Google Maps API</a> a été utilisé pour créer cette visualisation.</p>
	<p>Comme les cartes fournies par la NASA étaient dans une projection différente que celle requise par Google Maps, le <a href="http://www.gdal.org/">GDAL - Geospatial Data Abstraction Library</a> bibliothèque a été utilisé pour la conversion.</p>
    ...
    <p>La superposition jour / nuit utilise le <a href="https://github.com/marmat/google-maps-api-addons">Google Maps API Addons</a>.</p>
...
// Google Earth
$lang['GOOGLEEARTH_H1']    = 'Google Earth: carte du monde en 3D';
$lang['GOOGLEEARTH_BODY1'] = 'Maintenant vous voyez les images de la <cite>Terre Nuit</cite> de <cite>Google Earth</cite>.';
$lang['GOOGLEEARTH_BODY2'] = 'Pour voir les images <cite>Terre Nuit</cite> en <cite>Google Earth</cite>:';
$lang['GOOGLEEARTH_BODY3'] = 'cliquez ici pour ajouter des images à Google Earth dans la nuit';
$lang['GOOGLEEARTH_BODY4'] = 'Si vous n\'avez pas installé <cite>Google Earth</cite> vous pouvez télécharger <b>gratuitement</b>.';
