...
$lang['INDEX_BODY']        = '<p>Este mapa nocturno de la Tierra muestra las luces visibles en la superficie de la Tierra.</p>
	...
	<ul><li>La imagen principal de la Tierra de noche (2012) fue capturada por la <a href="http://earthobservatory.nasa.gov/?eocn=topnav&amp;eoci=logo">NASA</a> usando el satélite Suomi National Polar-orbiting Partnership (Suomi NPP). Llevó nueve días en abril de 2012 y trece días en octubre de 2012, durante 312 órbitas a 824 kilometros (512 millas) para capturar toda la Tierra. Este satélite utiliza la "banda de día-noche" del Visible Infrared Imaging Radiometer Suite (VIIRS), que detecta la luz en una gama de longitudes de onda del verde al infrarrojo cercano y utiliza técnicas de filtrado para observar señales tenues como llamaradas de gas, auroras, incendios, luces ciudades, así como luz de Luna reflejada.</li>
	<li>La <a href="showitem.php?item=night_map_earth">imagen original de 2000</a> fue creada por la <a href="http://www.nasa.gov" target="_blank">NASA</a> usando datos del programa <a href="http://www.ngdc.noaa.gov/dmsp/" target="_blank">Defense Meteorological Satellite Program (DMSP)</a> del <a href="http://thunder.msfc.nasa.gov/ols/" target="_blank">Operational Linescan System (OLS)</a>, originalmente diseñado para ver nubes bajo la luz de la Luna.</li></ul>
	<p>Las imágenes diurnas proporcionadas por Google Maps (vistas de mapas y satélite) también están disponibles como referencia. El <a href="https://developers.google.com/maps/">Google Maps API</a> fue utilizado para crear esta visualización.</p>
	<p>Como los mapas proporcionados por la NASA estaban en una proyección diferente de la requerida por Google Maps, la librería <a href="http://www.gdal.org/">GDAL - Geospatial Data Abstraction Library</a> ha sido utilizada para la conversión.</p>
    ...
    <p>La superposición dia/noche utiliza los <a href="https://github.com/marmat/google-maps-api-addons">Google Maps API Addons</a>.</p>
...
// Google Earth
$lang['GOOGLEEARTH_H1']    = 'Google Earth: Mapa del mundo en 3D';
$lang['GOOGLEEARTH_BODY1'] = 'Ahora puedes ver las imágenes de <cite>Night Earth</cite> desde <cite>Google Earth</cite>.';
$lang['GOOGLEEARTH_BODY2'] = 'Para ver las imágenes de <cite>Night Earth</cite> en <cite>Google Earth</cite>:';
$lang['GOOGLEEARTH_BODY3'] = 'pincha aquí para añadir imágenes nocturnas a Google Earth';
$lang['GOOGLEEARTH_BODY4'] = 'Si no tienes instalado <cite>Google Earth</cite> puedes descargarlo <b>gratis</b>.';
