...
$lang['INDEX_BODY']        = '<p>O mapa noite Terra mostra as luzes que são visíveis à noite na superfície da Terra.</p>
	...
	<ul><li>A principal imagem da Terra à noite (2012) foi capturado por <a href="http://earthobservatory.nasa.gov/?eocn=topnav&amp;eoci=logo">NASA</a> usando o Suomi National Polar-orbiting Partnership (Suomi NPP) satélite. Levou mais de nove dias em abril de 2012 e 13 dias em outubro de 2012, durante 312 órbitas em 824 km (512 milhas) para capturar toda a Terra. Este satélite usa o "dia-noite band" do Visible Infrared Imaging Radiometer Suite (VIIRS), que detecta a luz numa gama de comprimentos de onda de verde para infravermelho próximo e usa técnicas de filtragem para observar sinais escuros como chamas de gás, as auroras, incêndios florestais, luzes da cidade, e refletia o luar.</li>
	<li>A <a href="showitem.php?item=night_map_earth">imagem original de 2000</a> foi criado pela <a href="http://www.nasa.gov" target="_blank">NASA</a> utilizando dados do <a href="http://www.ngdc.noaa.gov/dmsp/" target="_blank">Defense Meteorological Satellite Program (DMSP)</a>\'s <a href="http://thunder.msfc.nasa.gov/ols/" target="_blank">Operational Linescan System (OLS)</a>, originalmente concebido para ver nuvens pelo luar.</li></ul>
	<p>As imagens diurnas fornecidas pelo Google Maps (mapas e imagens de satélite) também estão disponíveis para referência. A <a href="https://developers.google.com/maps/">Google Maps API</a> foi utilizado para a criação deste visualização.</p>
	<p>Como os mapas fornecidos pela NASA estavam em uma projeção diferente como o solicitado através do Google Maps, o <a href="http://www.gdal.org/">GDAL - Geospatial Data Abstraction Library</a> biblioteca foi utilizada para a conversão.</p>
    ...
    <p>A sobreposição de dia / noite usa o <a href="https://github.com/marmat/google-maps-api-addons">Google Maps API Addons</a>.</p>
...
// Google Earth
$lang['GOOGLEEARTH_H1']    = 'Google Earth: Mapa do mundo en 3D';
$lang['GOOGLEEARTH_BODY1'] = 'Agora você vê as fotos de <cite>Noite Terra</cite> de <cite>Google Earth</cite>.';
$lang['GOOGLEEARTH_BODY2'] = 'Para visualizar as imagens <cite>Noite Terra</cite> no <cite>Google Earth</cite>:';
$lang['GOOGLEEARTH_BODY3'] = 'clique aqui para adicionar imagens a Google Earth à noite';
$lang['GOOGLEEARTH_BODY4'] = 'Se você tiver o <cite>Google Earth</cite>instalado, pode baixar <b>livre</b>.';
