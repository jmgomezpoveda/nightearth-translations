...
$lang['INDEX_BODY']        = '<p>밤 지구지도는 지구 표면에 밤에 볼 수 있습니다 빛을 보여줍니다.</p>
	...
	<ul><li>밤에 지구의 메인 이미지 (2012)가 붙 잡혔다 <a href="http://earthobservatory.nasa.gov/?eocn=topnav&amp;eoci=logo">NASA</a> 사용 Suomi National Polar-orbiting Partnership (Suomi NPP) 위성. 그것은 지구 전체를 캡처 824km (5백12마일)에서 312 궤도 동안 10 월 2012 년 2012년 4월 및 십삼일에 구일 인수했다. 이 위성의 "일 밤 밴드"를 사용 Visible Infrared Imaging Radiometer Suite (VIIRS), 이는 근적외선이 녹색에서 파장 범위에서 빛을 감지하고 가스 불, 오로라, 산불, 도시의 불빛과 같은 희미한 신호를 관찰하는 필터링 기술을 사용하고, 달빛을 반영합니다.</li>
	<li><a href="showitem.php?item=night_map_earth">2000 원 화상</a> 에 의해 만들어진 <a href="http://www.nasa.gov" target="_blank">NASA</a> 데이터를 사용 <a href="http://www.ngdc.noaa.gov/dmsp/" target="_blank">Defense Meteorological Satellite Program (DMSP)</a>\'s <a href="http://thunder.msfc.nasa.gov/ols/" target="_blank">Operational Linescan System (OLS)</a>, 원래 달빛 구름을 볼 수 있도록 설계.</li></ul>
	<p>구글 맵 (지도와 위성보기)에서 제공하는 일광 화상은 참고를 위해 유효하다. <a href="https://developers.google.com/maps/">Google Maps API</a> 이 시각화를 만들기 위해 사용되었다.</p>
	<p>NASA에서 제공하는지도는 구글 맵에 의해 요구 된 것과 다른 투사에 있었던 것처럼, <a href="http://www.gdal.org/">GDAL - Geospatial Data Abstraction Library</a> 라이브러리는 변환을 위해 사용되었다.</p>
    ...
    <p>주간 / 야간 오버레이를 사용하는 <a href="https://github.com/marmat/google-maps-api-addons">Google Maps API Addons</a>.</p>
...
// Google Earth
$lang['GOOGLEEARTH_H1']    = 'Google 어스 : 차원의 세계지도';
$lang['GOOGLEEARTH_BODY1'] = '지금의 이미지를 볼 수 있습니다 <cite>야간 지구</cite> 내부 <cite>Google 어스</cite>.';
$lang['GOOGLEEARTH_BODY2'] = '보기 위해 <cite>야간 지구</cite> 이미지 내에 <cite>Google 어스</cite>:';
$lang['GOOGLEEARTH_BODY3'] = 'Google 어스 야간 이미지를 추가하려면 여기를 클릭하십시오';
$lang['GOOGLEEARTH_BODY4'] = '당신이 <cite>Google 어스</cite> 설치, 당신은 그것을 다운로드하실 수 있습니다 <b>무료</b>.';
