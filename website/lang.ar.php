...
$lang['INDEX_BODY']        = '<p>خريطة يلة الأرض تظهر الأضواء التي تكون مرئية في الليل على سطح الأرض.</p>
	...
	<ul><li>تم التقاط الصورة الرئيسية من الأرض في الليل (2012) من قبل <a href="http://earthobservatory.nasa.gov/?eocn=topnav&amp;eoci=logo">NASA</a> باستخدام Suomi National Polar-orbiting Partnership (Suomi NPP) satellite. استغرق الأمر أكثر من تسعة أيام في شهر أبريل عام 2012، وثلاثة عشر يوما في أكتوبر 2012، وخلال 312 مدارات على 824 كيلومترا (512 ميلا) للقبض على الأرض كلها. يستخدم هذا القمر الصناعي في "الفرقة الليل والنهار" لل Visible Infrared Imaging Radiometer Suite (VIIRS), الذي يكتشف في ضوء مجموعة من الأطوال الموجية من الأخضر إلى بالقرب من الأشعة تحت الحمراء ويستخدم تقنيات الترشيح لمراقبة إشارات خافتة مثل مشاعل الغاز، الشفق، وحرائق الغابات، أضواء المدينة، وينعكس ضوء القمر.</li>
	<li><a href="showitem.php?item=night_map_earth">الصورة الأصلية من عام 2000</a> تم إنشاؤه من قبل <a href="http://www.nasa.gov" target="_blank">NASA</a> باستخدام بيانات من <a href="http://www.ngdc.noaa.gov/dmsp/" target="_blank">Defense Meteorological Satellite Program (DMSP)</a>\'s <a href="http://thunder.msfc.nasa.gov/ols/" target="_blank">Operational Linescan System (OLS)</a>, مصممة أصلا لعرض السحب على ضوء القمر.</li></ul>
	<p>الصور ضوء النهار التي تقدمها خرائط جوجل (الخرائط ومشاهدة الأقمار الصناعية) متاحة للإشارة أيضا. و <a href="https://developers.google.com/maps/">Google Maps API</a> كانت تستخدم لخلق هذا التصور.</p>
	<p>كانت ليالي الخرائط التي تقدمها وكالة ناسا في إسقاط مختلفة مثل واحد التي تتطلبها خرائط جوجل، <a href="http://www.gdal.org/">GDAL - Geospatial Data Abstraction Library</a> كان يستخدم مكتبة للتحويل.</p>
    ...
    <p>يستخدم تراكب يوم / ليلة <a href="https://github.com/marmat/google-maps-api-addons">Google Maps API Addons</a>.</p>    
...
// Google Earth
$lang['GOOGLEEARTH_H1']    = 'جوجل الأرض : خريطة العالم في 3D';
$lang['GOOGLEEARTH_BODY1'] = 'يمكنك الآن رؤية صور <cite>ليلة الأرض</cite> داخل <cite>جوجل الأرض</cite>.';
$lang['GOOGLEEARTH_BODY2'] = 'من أجل عرض <cite>ليلة الأرض</cite> وضع الصور داخل <cite>جوجل الأرض</cite>:';
$lang['GOOGLEEARTH_BODY3'] = 'انقر هنا لإضافة صور ليلة لبرنامج Google Earth';
$lang['GOOGLEEARTH_BODY4'] = 'إذا لم يكن لديك <cite>Google Earth</cite> وتثبيتها، يمكنك تحميله <b>مجانا</b>.';
